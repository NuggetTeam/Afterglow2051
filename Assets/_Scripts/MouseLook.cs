...
public class MouseLook : MonoBehaviour{
    ...
    void Update(){
		...
		if(Input.GetKeyDown(KeyCode.R)){active = !active;}

		Cursor.visible = false;


		if (Input.GetKeyDown(KeyCode.L)) Look(GameObject.Find("LloydBarman"));
	...
	public void SetMouseLook(bool ac){
	...
	public void Look(GameObject go){
		Debug.Log ("AQUI");
		_mouseAbsolute.x = -12f;
		_mouseAbsolute.y = -1.2f;
